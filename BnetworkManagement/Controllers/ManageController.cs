...
using BnetworkManagement.Models.ManageViewModels;
    ...
    public class ManageController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
            ...
            var model = new IndexViewModel
            {
                ...
                AffiliateCode = user.AffiliateCode==null ? null : user.AffiliateCode.Code,
                HasAffiliate = user.AffiliateCode==null ? false : true
            };
        ...
        public async Task<IActionResult> Index(IndexViewModel model)
        {
            ...
            var affiliateCode = model.AffiliateCode;
            if (affiliateCode != null && model.HasAffiliate == false)
            {
                // check if their affiliate code is unique

                var affCodes = _context.AppUsers.Where(p => p.AffiliateCode.Code == affiliateCode);
                if (affCodes.Any() == true)
                {
                    ModelState.AddModelError(string.Empty, "That Affiliate Code is Already Taken; Try Another.");
                    return View(model);
                }
                else
                {
                    var NewAffiliate = new DiscountCode
                    {
                        Code = affiliateCode,
                    ...
                    user.AffiliateCode = NewAffiliate;
                    _context.Add(NewAffiliate);
        ...
        public async Task<IActionResult> SendVerificationEmail()
        {
            ...
            var code = await _userManager.GenerateEmailConfirmationTokenAsync(user/*, "Bnetwork", "resetWallet"*/);
            var callbackUrl = Url.WalletConfirmationLink(user.Id, code, Request.Scheme);
            var email = user.Email;
        ...
        [HttpGet]
        [Authorize]
        public async Task<IActionResult> ChangeWallet()
        {
            if (!ModelState.IsValid)
            {
                return View();
            ...
            if (wallet == null)
            {
                return View(new ChangeWalletViewModel
                {
        ...
        private string GenerateQrCodeUri(string email, string unformattedKey)
        {
            return string.Format(
                ...
                _urlEncoder.Encode("BnetworkManagement"),
